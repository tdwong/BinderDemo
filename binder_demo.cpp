...
void *clnt_wait_func(void *ptr)
{
	...
	ALOGD("clnt_wait_func exiting... gClientRun=%d",gClientRun);
...
///			IPCThreadState::self()->joinThreadPool();
			// pthread_join() required as clnt_wait_func() thread was launched via pthread_create()
